...
SELECT language.language_id, language.name, COUNT(film.film_id) language FROM language 
...
SELECT a.actor_id, a.first_name, a.last_name, COUNT(film_actor.film_id)
FROM actor a
